...
const (
	...
	Application_UpdateManagementPrivateItem_FullMethodName = "/gateway.Application/UpdateManagementPrivateItem"
...
type ApplicationClient interface {
	...
	UpdateManagementPrivateItem(ctx context.Context, in *UpdateManagementPrivateItemRequest, opts ...grpc.CallOption) (*UpdateManagementPrivateItemResponse, error)
...
func (c *applicationClient) UpdateManagementPrivateItem(ctx context.Context, in *UpdateManagementPrivateItemRequest, opts ...grpc.CallOption) (*UpdateManagementPrivateItemResponse, error) {
	out := new(UpdateManagementPrivateItemResponse)
	err := c.cc.Invoke(ctx, Application_UpdateManagementPrivateItem_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ApplicationServer interface {
	...
	// Update private information in application by id
	UpdateManagementPrivateItem(context.Context, *UpdateManagementPrivateItemRequest) (*UpdateManagementPrivateItemResponse, error)
	// Update application status
...
func (UnimplementedApplicationServer) UpdateManagementPrivateItem(context.Context, *UpdateManagementPrivateItemRequest) (*UpdateManagementPrivateItemResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpdateManagementPrivateItem not implemented")
}
...
func _Application_UpdateManagementPrivateItem_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UpdateManagementPrivateItemRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ApplicationServer).UpdateManagementPrivateItem(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Application_UpdateManagementPrivateItem_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ApplicationServer).UpdateManagementPrivateItem(ctx, req.(*UpdateManagementPrivateItemRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Application_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "UpdateManagementPrivateItem",
			Handler:    _Application_UpdateManagementPrivateItem_Handler,
		},
		{
